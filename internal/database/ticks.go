...
FROM ticks WHERE id = ?`
	...
	err := db.QueryRowContext(ctx, q, id).Scan(
		...
		&t.TokensIn, &t.TokensOut, &t.CostUSD, &t.CostSource, &t.Urgency, &t.WeightUsed,
